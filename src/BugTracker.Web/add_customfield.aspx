<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedIn.Master" CodeBehind="add_customfield.aspx.cs" Inherits="BugTracker.Web.add_customfield" AutoEventWireup="True" %>
					...
					<form class=frm runat="server">
						<table border=0>
							...
							<tr>
								...
								<td><asp:DropDownList id="dropdown_type" runat="server"></asp:DropDownList></td>
								<td>&nbsp</td>
							</tr>
							...
							<tr>
								...
								<td>
									<asp:DropDownList id="datatype" runat="server"></asp:DropDownList>
								</td>

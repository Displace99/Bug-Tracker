<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedIn.Master" CodeBehind="edit_customfield.aspx.cs" Inherits="BugTracker.Web.edit_customfield" AutoEventWireup="True" %>
				...
				<td>
					...
					<form class=frm runat="server">
						<table border=0>
							<tr>
								<td colspan=3>
									Field Name:&nbsp;<span class=smallnote style="font-size: 12pt; font-weight: bold;" id="name" runat="server"></span>
								</td>
							</tr>
							...
							<tr>
								<td colspan=3>
									<span class=smallnote>Controls what order the custom fields display on the page.</span>
								</td>
							</tr>

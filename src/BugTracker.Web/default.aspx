...
<html lang="en">
	...
	<body onload="document.forms[0].user.focus()">
		...
		<span>
			<a target=_blank style=" font-size: 7pt; font-family: arial, sans-serif; letter-spacing: 1px;" href="https://bug-tracker.readthedocs.io/en/latest/">Help</a>
			<br>
			<a target=_blank style=" font-size: 7pt; font-family: arial, sans-serif; letter-spacing: 1px;" href="https://github.com/Displace99/Bug-Tracker/issues">Feedback</a>
			<br>
			<a target=_blank style=" font-size: 7pt; font-family: arial, sans-serif; letter-spacing: 1px;" href="about.html">About</a>
		</span>
		</div>
		<table border=0><tr>
